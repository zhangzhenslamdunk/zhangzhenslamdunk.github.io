...
SDK.translators = {
	...
	"zh" : {
		...
		"Enter name" : "è¼¸å¥åå­",
		"Chat Log" : "èå¤©è¨é",
		"Choose Language" : "é¸æèªè¨",
		"Enter valid email" : "è¼¸å¥ææçéµä»¶",
		"Ping server" : "å®å¹æåå¨",
		"Flag user" : "æ¨è¨ç¨æ¶",
		"Whisper user" : "è³èªç¨æ¶",
		"Request private" : "è«æ±ç§äºº",
		"Clear log" : "æ¸é¤æ¥èª",
		"Accept private" : "æ¥åç§äºº",
		"Send image" : "ç¼éåå",
		"Send file" : "ç¼éæä»¶",
		"Email Chat Log" : "é»å­éµä»¶èå¤©æ¥èª",
		"Chime" : "é",
		"Exit chat" : "éåºèå¤©",
		"Text to speech" : "æå­è½èªé³",
		"Speech recognition" : "èªé³è­å¥",
		"Speech Recognition" : "èªé³è­å¥",
		"Quit private channel" : "éåºç§äººé »é",
		"Quit private or channel" : "éåºç§äººæé »é",
		"Would you like a copy of the chat log sent to your email?" : "ä½ æ³è¦ç¼éå°ä½ çé»å­éµä»¶çèå¤©è¨éçå¯æ¬å?"
	},
	"ja" : {
		"Yes" : "ã¯ã",
		"No" : "ããã",
		...
		"Disconnect" : "åæ­ãã",
		"Speech" : "ã¹ãã¼ã",
		"Enter name" : "ååãå¥å",
		"Chat Log" : "ãã£ããã­ã°",
		"Clear log" : "ã­ã°ãã¯ãªã¢ãã",
		"Choose Language" : "è¨èªãé¸æãã",
		"Enter valid email" : "æå¹ãªã¡ã¼ã«ã¢ãã¬ã¹ãå¥å",
		"Ping server" : "ãªã³ã°ãµã¼ãã¼",
		"Flag user" : "ã¦ã¼ã¶ã¼ã«ãã©ã°ãè¨­å®ãã",
		"Whisper user" : "ããããã¦ã¼ã¶ã¼",
		"Request private" : "ãã©ã¤ãã¼ãããªã¯ã¨ã¹ããã",
		"Accept private" : "ãã©ã¤ãã¼ããåãå¥ãã",
		"Send image" : "ç»åãéã",
		"Send file" : "ãã¡ã¤ã«ãéä¿¡",
		"Upload image" : "ç»åãã¢ããã­ã¼ããã",
		"Upload file" : "ãã¡ã¤ã«ãã¢ããã­ã¼ããã",
		"Email Chat Log" : "ã¡ã¼ã«ãã£ããã­ã°",
		"Chime" : "ãã£ã¤ã ",
		"Exit chat" : "ãã£ãããçµäº",
		"Text to speech" : "ã¹ãã¼ããã­ã¹ã",
		"Speech recognition" : "é³å£°èªè­",
		"Speech Recognition" : "é³å£°èªè­",
		"Quit private channel" : "ãã©ã¤ãã¼ããã£ã³ãã«ãçµäºãã",
		"Quit private or channel" : "ãã©ã¤ãã¼ãã¾ãã¯ãã£ã³ãã«ãçµäºãã",
		"Would you like a copy of the chat log sent to your email?" : "ãã£ããã­ã°ã®ã³ãã¼ãã¡ã¼ã«ã«éä¿¡ãã¾ãã?"
	},
	"ar" : {
		"Yes" : "ÙØ¹Ù ÙØ¹ÙØ§",
		"No" : "ÙØ§",
		...
		"Clear log" : "Ø³Ø¬Ù ÙØ¸ÙÙ",
		"Choose Language" : "Ø§Ø®ØªØ± Ø§ÙÙØºØ©",
		"Enter valid email" : "Ø£Ø¯Ø®Ù Ø¨Ø±ÙØ¯ Ø¥ÙÙØªØ±ÙÙÙ ØµØ§ÙØ­Ø§",
		"Ping server" : "Ø®Ø§Ø¯Ù Ø¨ÙÙØº",
		"Flag user" : "ÙØ³ØªØ®Ø¯Ù Ø§ÙØ¹ÙÙ",
		"Whisper user" : "Ø§ÙÙÙØ³ Ø§ÙÙØ³ØªØ®Ø¯Ù",
		"Request private" : "Ø·ÙØ¨ Ø®Ø§Øµ",
		"Clear Log" : "Ø³Ø¬Ù ÙØ¸ÙÙ",
		"Accept private" : "ÙØ¨ÙÙ Ø®Ø§Øµ",
		"Send image" : "Ø¥Ø±Ø³Ø§Ù ØµÙØ±Ø©",
		"Send file" : "Ø¥Ø±Ø³Ø§Ù ÙÙÙ",
		"Email Chat Log" : "Ø³Ø¬Ù Ø§ÙØ¯Ø±Ø¯Ø´Ø© Ø¹Ø¨Ø± Ø§ÙØ¨Ø±ÙØ¯ Ø§ÙØ¥ÙÙØªØ±ÙÙÙ",
		"Chime" : "ÙØ±Ø¹ Ø§ÙØ£Ø¬Ø±Ø§Ø³",
		"Exit chat" : "Ø§ÙØ®Ø±ÙØ¬ ÙÙ Ø§ÙØ¯Ø±Ø¯Ø´Ø©",
		"Text to speech" : "Ø§ÙÙØµ Ø¥ÙÙ Ø§ÙÙÙØ§Ù",
		"Speech Recognition" : "Ø§ÙØªØ¹Ø±Ù Ø¹ÙÙ Ø§ÙÙÙØ§Ù",
		"Quit private channel" : "Ø¥ÙÙØ§Ø¡ Ø§ÙÙÙØ§Ø© Ø§ÙØ®Ø§ØµØ©",
		"Quit private or channel": "Ø¥ÙÙØ§Ø¡ Ø®Ø§Øµ Ø£Ù ÙÙØ§Ø©",
		"Would you like a copy of the chat log sent to your email?" : "ÙÙ ØªØ±ÙØ¯ Ø¥Ø±Ø³Ø§Ù ÙØ³Ø®Ø© ÙÙ Ø³Ø¬Ù Ø§ÙØ¯Ø±Ø¯Ø´Ø© Ø¥ÙÙ Ø¨Ø±ÙØ¯Ù Ø§ÙØ¥ÙÙØªØ±ÙÙÙØ"
	},
	"ru" : {
		"Yes" : "ÐÐ°",
		"No" : "HÐµÑ",
		...
		"Email": "Ð­Ð». Ð¿Ð¾ÑÑÐ°",
		"Phone" : "Ð¢ÐµÐ»ÐµÑÐ¾Ð½",
		"Connect" : "CÐ¾ÐµÐ´Ð¸Ð½Ð¸ÑÑ",
		"Disconnect" : "ÐÑÐºÐ»ÑÑÐ¸ÑÑ",
		"Speech" : "PÐµÑÑ",
		"Enter name" : "ÐÐ²ÐµÐ´Ð¸ÑÐµ Ð¸Ð¼Ñ",
		"Chat Log" : "ÐÑÑÐ½Ð°Ð» ÑÐ°ÑÐ°",
		"Choose Language" : "ÐÑÐ±ÐµÑÐ¸ÑÐµ ÑÐ·ÑÐº",
		"Enter valid email" : "ÐÐ²ÐµÐ´Ð¸ÑÐµ Ð´ÐµÐ¹ÑÑÐ²ÑÑÑÐ¸Ð¹ Ð°Ð´ÑÐµÑ ÑÐ»ÐµÐºÑÑÐ¾Ð½Ð½Ð¾Ð¹ Ð¿Ð¾ÑÑÑ",
		"Ping server" : "ÐÐ¸Ð½Ð³ ÑÐµÑÐ²ÐµÑ",
		"Flag user" : "OÑÐ¼ÐµÑÐ¸ÑÑ Ð¿Ð¾Ð»ÑÐ·Ð¾Ð²Ð°ÑÐµÐ»Ñ",
		"Whisper user" : "ÐÑÐ¾ÑÐµÐ¿ÑÐ°ÑÑ Ð¿Ð¾Ð»ÑÐ·Ð¾Ð²Ð°ÑÐµÐ»Ñ",
		"Request private" : "Ð§Ð°ÑÑÐ½ÑÐ¹ Ð·Ð°Ð¿ÑÐ¾Ñ",
		"Clear log" : "ÐÑÐ¸ÑÑÐ¸ÑÑ Ð¶ÑÑÐ½Ð°Ð»",
		"Clear Log" : "ÐÑÐ¸ÑÑÐ¸ÑÑ Ð¶ÑÑÐ½Ð°Ð»",
		"Accept private" : "ÐÑÐ¸Ð½ÑÑÑ ÐºÐ¾Ð½ÑÐ¸Ð´ÐµÐ½ÑÐ¸Ð°Ð»ÑÐ½o",
		"Send image" : "ÐÑÐ¿ÑÐ°Ð²Ð¸ÑÑ Ð¸Ð·Ð¾Ð±ÑÐ°Ð¶ÐµÐ½Ð¸Ðµ",
		"Send file" : "ÐÑÐ¿ÑÐ°Ð²Ð¸ÑÑ ÑÐ°Ð¹Ð»",
		"Email Chat Log" : "OÑÐ¿ÑÐ°Ð²Ð¸ÑÑ Ð¶ÑÑÐ½Ð°Ð» ÑÐ°ÑÐ° Ð¿Ð¾ ÑÐ»ÐµÐºÑÑÐ¾Ð½Ð½Ð¾Ð¹ Ð¿Ð¾ÑÑÐµ",
		"Chime" : "ÐÐ²Ð¾Ð½Ð¾Ðº",
		"Exit chat" : "ÐÑÑÐ¾Ð´ Ð¸Ð· ÑÐ°ÑÐ°",
		"Text to speech" : "Ð¢ÐµÐºÑÑ Ð² ÑÐµÑÑ",
		...
		"Would you like a copy of the chat log sent to your email?" : "OÑÐ¿ÑÐ°Ð²Ð¸ÑÑ ÐºÐ¾Ð¿Ñ Ð¶ÑÑÐ½Ð°Ð»Ð° ÑÐ°ÑÐ° Ð½Ð° Ð²Ð°Ñ Ð°Ð´ÑÐµÑ ÑÐ»ÐµÐºÑÑÐ¾Ð½Ð½Ð¾Ð¹ Ð¿Ð¾ÑÑÑ?"
	}
}
		...
		if (this.showFile) {
			...
			html = html
				...
				+ "<div class='" + this.prefix + "dialog-div'>\n"
					...
					+ "Resize to <input id='" + this.prefix + "resize-width' type='number' value='600' style='width:50px;height:25px' title='Image resize width in pixels'> pixels\n"
				+ "</div>\n";
		}
		if (this.showURL) {
...
SDK.updateAvatar = function(responseMessage, speak, urlprefix, elementPrefix, channelaudio, afterFunction, nativeVoice, lang, voice) {
	...
	if (isVideo && useVideo) {
		...
		if (responseMessage.avatarAction != null) {
			...
			//var onended = video.onended;
			video.onended = function() {
				// This causes a talk loop for native speech.
				//if (onended != null) {
				//	onended();
				//}
				talk();
		...
		html = html
			...
			+ "<div id='" + this.prefix + "boxbar' class='" + this.prefix + "boxbar'>"
				+ "<div id='" + this.prefix + "boxbar2' class='" + this.prefix + "boxbar2'>"
					...
					+ " <a id='" + this.prefix + "boxclose' class='" + this.prefix + "boxclose' onclick='return false;' onclick='return false;' href='#'> </a></span><br/>"
				+ "</div>";
		html = html
				+ "<div id='" + this.prefix + "boxbar3' class='" + this.prefix + "boxbar3'" + ">"
					...
					+ " <a id='" + this.prefix + "boxclose2' class='" + this.prefix + "boxclose2' onclick='return false;' onclick='return false;' href='#'> </a></span><br/>"
				+ "</div>\n"
			+ "</div>\n";
...
function SDKConnection() {
	...
	*/
	this.testAnalytic = function(config, file, resize, form, processor) {
		var self = this;
		if (!resize && file.size > SDK.MAX_FILE_UPLOAD) {
			...
			if (resize) {
				this.POST_IMAGE(this.credentials.rest + "/test-analytic", file, form, config.toXML(), function(xml) {
					if (xml == null) {
						return null;
					}
	...
	this.sendAnalyticImage = function(analyticConfig ,processor, inputProcessor) {
		if (!(window.File && window.FileReader && window.FileList && window.Blob)) {
			alert('The File APIs are not fully supported in this browser.');
			return false;
		}
		...
		fileInput.onchange = function() {
			...
			self.testAnalytic(analyticConfig, file, true, form, processor);
		}
		fileInput.click();
		return false;
	};
